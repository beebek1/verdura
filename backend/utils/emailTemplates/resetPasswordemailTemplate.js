const resetPasswordemailTemplate = (verifyLink) =>`
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:20px;padding-right:10px;padding-top:10px;">
																<div style="color:#848484;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:1.8;text-align:center;mso-line-height-alt:25px;">
																	<p style="margin: 0; word-break: break-word;">A password reset was requested for your account. Use the link below to set a new password securely</p>
																</div>
															</td>
														</tr>
													</table>
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"  href="www.example.com"  style="height:42px;width:156px;v-text-anchor:middle;" arcsize="9%" fillcolor="#2a313d">
