...
<![endif]--><!--[if !mso]><!--><!--<![endif]-->
	<style>
		* {
		...
		#menu-r7c0m1:checked~.menu-links {
			background-color: #000000 !important;
		}

		#menu-r7c0m1:checked~.menu-links a,
		#menu-r7c0m1:checked~.menu-links span {
			color: #ffffff !important;
		}
	</style><!--[if mso ]><style>sup, sub { font-size: 100% !important; } sup { mso-text-raise:10% } sub { mso-text-raise:-10% }</style> <![endif]-->
</head>

<body class="body" style="background-color: #2a313d; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
	<table class="nl-container" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #2a313d;">
		<tbody>
			<tr>
				<td>
														...
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center">
																	<div style="max-width: 226.667px;"><img src="https://324e8f6c17.imgdist.com/pub/bfra/tjxtrqbj/eyf/s5c/xlt/logo.png" style="display: block; height: auto; border: 0; width: 100%;" width="226.667" alt title height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
													...
													<table class="heading_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="text-align:center;width:100%;">
																<h1 style="margin: 0; color: #101010; direction: ltr; font-family: Arial, Helvetica Neue, Helvetica, sans-serif; font-size: 27px; font-weight: normal; letter-spacing: normal; line-height: 1.2; text-align: center; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 32px;"><strong>Verify your email address</strong></h1>
															</td>
														</tr>
													</table>
												</td>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:20px;padding-right:10px;padding-top:10px;">
																<div style="color:#848484;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:14px;line-height:1.8;text-align:center;mso-line-height-alt:25px;">
																	<p style="margin: 0; word-break: break-word;">Thanks for signing up. Please verify your email address by clicking the button below to activate your account.</p>
																</div>
															</td>
														</tr>
													</table>
